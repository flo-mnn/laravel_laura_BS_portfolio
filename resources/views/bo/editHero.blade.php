...
<section id="hero" style="background-image: url('storage/img/{{$page_images[0]->src}}');">
    <div class="hero-container">
       ...
       <div class="text-center edit-parent title-update-div">
        <button type="button" data-toggle="modal" id="heroes" data-target="#edit-title" class="edit edit-title btn btn-warning rounded-circle px-3 py-2"><i class="bx bx-edit"></i></button>
