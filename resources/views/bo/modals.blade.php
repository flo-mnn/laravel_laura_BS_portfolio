...
<div class="modal fade" id="edit-education" >
    <div class="modal-dialog">
      <div class="modal-content">
        ...
        <div class="modal-body">
          <form action="/bo/education/update/id" method="POST" id="update-resume-education" >
            @csrf
            <div class="form-group">
            ...
            <div class="form-group">
              ...
              <input class="form-control" type="number" name="start_date" value="">
            </div>
            <div class="form-group">
              <label >End-date</label>
              <input class="form-control" type="number" name="end_date" aria-describedby="end-dateHelp">
              <small id="end-dateHelp" class="form-text text-muted">If end date is now, please leave as empty</small>
          ...
          <div class="modal-footer footer-update">
            <input type="submit" class="btn btn-success" value="Update" form="update-resume-education">
            <form action="/bo/resume/education/delete/id" method="POST" id="delete-education-form">
            @csrf
            <button type="submit" class="btn btn-danger">delete</button>
            </form>  
          </div>
          <div class="modal-footer footer-create d-none">
            <input type="submit" class="btn btn-primary" value="Add" form="update-resume-education">
            <button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button> 
          </div>
      </div>
    </div>
